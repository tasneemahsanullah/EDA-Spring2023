...
#4
#selecting Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, #SITE_LATITUDE, SITE_LONGITUDE in all four data sets
...
write.csv(Air_O3_2018, file = "./Data/Processed/EPAair_O3_NC2018_processed.csv", row.names=FALSE)

write.csv(Air_O3_2019, file = "./Data/Processed/EPAair_O3_NC2019_processed.csv", row.names=FALSE)

write.csv(Air_PM25_2018, file = "./Data/Processed/EPAair_PM25_NC2018_processed.csv", row.names=FALSE)

write.csv(Air_PM25_2019, file = "./Data/Processed/EPAair_PM25_NC2019_processed.csv", row.names=FALSE)
```
