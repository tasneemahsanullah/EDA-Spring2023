...
```{r,  message = FALSE}
Neonics <- read.csv("../Data/Raw/ECOTOX_Neonicotinoids_Insects_raw.csv",stringsAsFactors = TRUE)     #assigning the ECOTOX dataset to the variable "Neonics"
nf <- as.factor(Neonics) #read nenoics as a factor

Litter <- NEON_NIWO_Litter_massdata_2018_08_raw #assigning the NEON_NIWO dataset to the variable "Litter"
lf <- as.factor(Litter) #read lf as a factor
```
